...
/** Action to set a specific itemstat id for a piece of armor. Params: { slotId, itemstatId } */
...
/** Action to set the ascended flag on a specific piece of armor. Params: { slotId, isAscended } */
