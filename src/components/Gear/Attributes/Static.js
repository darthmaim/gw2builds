import {
    GEAR_TYPE_ARMOR_BOOTS, GEAR_TYPE_ARMOR_COAT, GEAR_TYPE_ARMOR_GLOVES, GEAR_TYPE_ARMOR_HELM, GEAR_TYPE_ARMOR_LEGGINGS,
    GEAR_TYPE_ARMOR_SHOULDERS,
    GEAR_TYPE_TRINKET_ACCESSORY, GEAR_TYPE_TRINKET_AMULET, GEAR_TYPE_TRINKET_BACK, GEAR_TYPE_TRINKET_JEWEL,
    GEAR_TYPE_TRINKET_RING,
    GEAR_TYPE_WEAPON_2HANDED, GEAR_TYPE_WEAPON_MAINHAND, GEAR_TYPE_WEAPON_OFFHAND
} from '../Constants';
...
export const attributeValues = {
    ...
    [GEAR_TYPE_WEAPON_MAINHAND.id]:   [125,  90, 108,  59,  59, 120,  85, 102,  56,  56],
    [GEAR_TYPE_WEAPON_OFFHAND.id]:    [125,  90, 108,  59,  59, 120,  85, 102,  56,  56],
...
export const attributeCombinations = {
    ...
    13: { "name": "Giver",      "availability": 31, "attributes": ["Toughness", "Healing", "BoonDuration"] },
    ...
    28: { "name": "Harrier",    "availability": 15, "attributes": ["Power", "Healing", "BoonDuration"] },
    ...
    32: { "name": "Seeker",       "availability": 32, "attributes": ["Power", "Precision", "BoonDuration", "CritDamage"] },
    33: { "name": "Destroyer",    "availability": 32, "attributes": ["Power", "Precision", "ConditionDamage", "CritDamage"] },
    34: { "name": "Diviner",      "availability": 32, "attributes": ["Power", "BoonDuration", "Precision", "CritDamage"] },
    ...
    38: { "name": "Commander",    "availability": 31, "attributes": ["Power", "Precision", "Toughness", "BoonDuration"] },
    39: { "name": "Marauder",     "availability": 63, "attributes": ["Power", "Precision", "Vitality", "CritDamage"] },
    41: { "name": "Vigilant",     "availability": 31, "attributes": ["Power", "Toughness", "BoonDuration", "ConditionDuration"] },
    42: { "name": "Crusader",     "availability": 31, "attributes": ["Power", "Toughness", "CritDamage", "Healing"] },
    43: { "name": "Wanderer",     "availability": 55, "attributes": ["Power", "Vitality", "Toughness", "BoonDuration"] },
    44: { "name": "Viper",        "availability": 63, "attributes": ["Power", "ConditionDamage", "Precision", "ConditionDuration"] },
    45: { "name": "Seraph",       "availability": 15, "attributes": ["Precision", "ConditionDamage", "BoonDuration", "Healing"] },
    46: { "name": "Trailblazer",  "availability": 31, "attributes": ["Toughness", "ConditionDamage", "Vitality", "ConditionDuration"] },
    47: { "name": "Minstrel",     "availability": 31, "attributes": ["Toughness", "Healing", "Vitality", "BoonDuration"] },
