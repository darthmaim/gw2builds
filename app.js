...
app.locals.css = function(file) { return app.locals.asset(path.join("css", file)); };
app.locals.js = function(file) { return app.locals.asset(path.join("js", file)); };
app.locals.img = function(file) { return app.locals.asset(path.join("img", file)); };
