...
export default {
    ...
    BlockDataGeneral: jBinary.Template({
        setParams: function () {
            this.baseType = {
                build: 'uint16',
    ...
    BlockDataSpecialization: jBinary.Template({
    ...
    BlocksArray: jBinary.Template({
        setParams: function (types) {
            this.baseType = ['array', ['Block', types]]
        },
    }),

    BuildSettings: jBinary.Template({
        setParams: function () {
            this.baseType = {
                types: 'Types',
                blocks: jBinary.Template({
