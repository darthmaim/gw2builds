...
describe('v0 typeset', () => {
    ...
    it('serializes bitflags as 1 condensed bit when all bits are true', () => {
        const binary = new JBinary(4, typeset);
        binary.write(['bitflags', ['field1', 'field2', 'field3', 'field4', 'field5']], {
            field1: true,
            field2: true,
            field3: true,
            field4: true,
    ...
    it('deserializes bitflags as 1 condensed bit when all bits are true', () => {
        const binary = new JBinary([128, 0, 0, 0], typeset);
        expect(binary.read(['bitflags', ['field1', 'field2', 'field3', 'field4', 'field5']])).to.deep.equal({
            field1: true,
            field2: true,
            field3: true,
            field4: true,
    ...
    it('serializes bitflags as separate bits when not all bits are true', () => {
        const binary = new JBinary(4, typeset);
        binary.write(['bitflags', ['field1', 'field2', 'field3', 'field4', 'field5']], {
            field1: true,
            field2: true,
    ...
    it('deserializes bitflags as separate bits when not all bits are true', () => {
