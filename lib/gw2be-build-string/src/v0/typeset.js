...
const customTypes = {
    item: [
        'gearUpdates.weaponA1',
        'gearUpdates.weaponA2',
        'gearUpdates.weaponB1',
        'gearUpdates.weaponB2',
        'gearUpdates.weaponAquaticA',
        'gearUpdates.weaponAquaticB',
        'gearUpdates.helm',
        'gearUpdates.shoulders',
        'gearUpdates.coat',
        'gearUpdates.gloves',
        'gearUpdates.leggings',
        'gearUpdates.boots',
        'gearUpdates.helmAquatic',
        'gearUpdates.backpack',
        'gearUpdates.accessory1',
        'gearUpdates.accessory2',
        'gearUpdates.amulet',
        'gearUpdates.ring1',
        'gearUpdates.ring2'
    ],
